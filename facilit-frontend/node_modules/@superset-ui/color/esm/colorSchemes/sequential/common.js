...
const schemes = [{
  id: 'paleta_roxa',
  label: 'paleta_roxa',
  colors: ['#fbeaff', '#eea5fc', '#bc73ca', '#9249a0', '#722980']
},{
...
},
{
  id: 'paraiba_total',
  label: 'paraiba_total',
  colors: ['#00ff00','#00ff00','#00ff00', '#ffff00', '#ffff00','#ffff00','#ffa500','#ffa500','#ffa500','#ff0000','#ff0000','#ff0000']
},
{
  id: 'paraiba_sem_vermelho',
  label: 'paraiba_sem_vermelho',
  colors: ['#00ff00','#00ff00','#00ff00', '#ffff00', '#ffff00','#ffff00','#ffa500','#ffa500','#ffa500',]
},
{
  id: 'paraiba_sem_verde',
  label: 'paraiba_sem_verde',
  colors: ['#ffff00', '#ffff00','#ffff00','#ffa500','#ffa500','#ffa500','#ff0000','#ff0000','#ff0000']
},
{
  id: 'paraiba_amarelo_verde',
  label: 'paraiba_amarelo_verde',
  colors: ['#00ff00','#00ff00','#00ff00','#ffff00', '#ffff00','#ffff00']
},
{
  id: 'paraiba_verde',
  label: 'paraiba_verde',
